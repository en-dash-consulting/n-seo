...
| Title | Status |
|-------|--------|
| [Document the weekly upgrade job in SCHEDULING.md and DEPLOY.md](./document-the-weekly-upgrade-job-in.md) | pending |
| [Template a weekly upgrade check as a scheduler job](./template-a-weekly-upgrade-check-as-a.md) | pending |
